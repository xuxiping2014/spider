...
import com.xinyunlian.spider.barcode.BarcodeAction;
...
public class XylSpiderMain {
    public static void main(String[] args)
    {
        ...
        if(!initProperties())
        {
            ...
            BaiduAction action =new BaiduAction(SystemConfig.FF_BAIDU_BARCODE_URL,"baidu");
//            BarcodeAction action =new BarcodeAction(SystemConfig.FF_BARCODE_URL,"barcode");
            action.login(null);
            action.creepData();
